...
-- table, you should create it score, the score value for the correction
...
BEGIN
    ...
    -- Check if project already exists in the table
    SELECT id INTO project_id FROM projects WHERE name = project_name LIMIT 1;
    
    -- If the project doesn't exist, create a new project and get its id
